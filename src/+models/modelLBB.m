classdef modelLBB
    properties
        ...
        b_linearity = true; % True if the model is linear with the displacement field
        b_stiffnessAnal = false; % True if there is a analyticalStiffnessMatrix implemented
    ...
    methods
        %% CONSTRUCTOR METHOD
        function obj = modelLBB(E,par_omega,damage,G0)
            % Pre Initialization %%
        ...
        function [f,history,mu] = T(obj,x,u,ii,jj,dof_vec,par_omega,separatorDamage,damage,history,noFail)
            ...
            norma = vecnorm(xi')'; 
            S = dot(eta',xi')'./norma.^2; % Calculate stretch
            ee = xi./norma; % Versor
